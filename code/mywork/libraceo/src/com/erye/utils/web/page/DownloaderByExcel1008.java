 ...
 *
 */
public class DownloaderByExcel1008 {
	...
	public static void main(String[] args) {
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				try {
					String url = str[3];
					String url_flag = str[7];
					if (TAG_NEW.equals(url_flag)) {
						url = TAG_NEW_URL + str[0] + TAG_HTML;
					} else if (TAG_OLD.equals(url_flag)) {
						url = str[3];
					} else {
						System.out.println(i + ":" + str[0] + ":没有协议....");
						continue;
					}
					...
					System.out.println(i + ":" + str[0] + "ERROR:" + e.getMessage());
				}
	...
	static String url = "E:\\百度云同步盘\\工作相关\\公司项目\\658金融\\工作备案\\2015-10-08【�?权转让原借款协议-赵恒】\\债权转让原�?款协�?xls";
	
	static String TAG_NEW_URL = "http://www.658.com/userTrade/contractDetail/financeID/";
	
	static String saveUrl = "E:\\百度云同步盘\\工作相关\\公司项目\\658金融\\工作备案\\2015-10-08【�?权转让原借款协议-赵恒】\\";
}
