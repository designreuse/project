 ...
 *
 */
public class CopyOfDownloaderByExcel {
	...
	public static String getFileName(String[] info) {
		String url = info[0].trim() + TAG__ + info[1] + TAG__ + TAG_INDEX;
	...
	static String TAG_INDEX = "5";
	
	static String url = "E:\\百度云同步盘\\工作相关\\公司项目\\658金融\\工作备案\\2015-09-23【投资单整理】\\新版网页\\5.xls";
	
	static String TAG_NEW_URL = "http://www.658.com/userTrade/contractDetail/financeID/";
	
	static String saveUrl = "E:\\百度云同步盘\\工作相关\\公司项目\\658金融\\工作备案\\2015-09-23【投资单整理】\\新版网页\\新版协议_ERROR\\";
}
